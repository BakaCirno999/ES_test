...
@Configuration
public class RebbitMqConfig implements InitializingBean {
    @Autowired
    ...
    public void afterPropertiesSet() throws Exception {
        rabbitTemplate.setConfirmCallback(new RabbitTemplate.ConfirmCallback() {
            ...
            public void confirm(CorrelationData correlationData, boolean ack, String cause) {
                System.out.println("Confirm====消息唯一标识: " + correlationData);
                System.out.println("Confirm====确认状态: {}" + ack);
                System.out.println("Confirm====造成原因: {}" + cause);
            }
        });
    }
    /**
